...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const res = await options.getString("prefix")
      ...
      prefixSchema.findOne({ Guild : interaction.guild.id }, async(err, data) => {
          ...
          if(data) {
              ...
              data.save()
              //interaction.channel.send(`Your prefix has been updated to **${res}**`)
          } else {
              data = new prefixSchema({
                  Guild : interaction.guild.id,
                  Prefix : res
      ...
      return interaction.reply({
        ...
        embeds: [
          ...
          .setTitle(`${client.allEmojis.check_mark} **The new Prefix is now: \`${res}\`**`)
        ],
      })
    } catch (e) {
